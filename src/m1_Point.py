...
class Point(object):
    ...
    def move_to(self, new_x, new_y):
        self.tot_distance += (((self.x - new_x) ** 2) + ((self.y - new_y) ** 2)) ** (0.5)
        self.x = new_x
        self.y = new_y
        self.count += 1
    ...
    def move_by(self, dx, dy):
        ...
        self.y += dy
        self.count += 1
        self.tot_distance += ((dx ** 2) + (dy ** 2)) ** (0.5)

    def get_number_of_moves_made(self):
        return self.count

    def get_distance_from(self, loc2):
        distance = (((self.x - loc2.x) ** 2) + ((self.y - loc2.y) ** 2)) ** (0.5)
        return distance

    def get_distance_from_start(self):
        start_distance = (((self.x - self.start_x) ** 2) + ((self.y - self.start_y) ** 2)) ** (0.5)
        return start_distance

    def get_distance_traveled(self):
        return self.tot_distance
